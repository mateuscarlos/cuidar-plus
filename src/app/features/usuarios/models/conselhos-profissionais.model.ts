...
export enum FuncoesComRegistro {
  ...
  ESCALA_PLANTOES = 1,
  SUPERVISAO_ENFERMAGEM = 2,
  TREINAMENTO_TECNICO = 3,
  AVALIACAO_PACIENTES_ENFERMAGEM = 4,
  
  // Setor Médico - CRM
  AVALIACAO_CLINICA = 5,
  PRESCRICAO_TRATAMENTOS = 6,
  ACOMPANHAMENTO_MEDICO = 7,
  EMISSAO_LAUDOS = 8,
  
  // Setor de Fisioterapia - CREFITO
  AVALIACAO_MOTORA = 9,
  PLANOS_TERAPEUTICOS = 10,
  SESSOES_DOMICILIARES = 11,
  REAVALIACAO_PERIODICA = 12,
  
  // Setor de Fonoaudiologia - CREFONO
  AVALIACAO_FONOAUDIOLOGICA = 13,
  SESSOES_REABILITACAO = 14,
  RELATORIOS_EVOLUCAO_FONO = 15,
  ORIENTACAO_FAMILIAR_FONO = 16,
  
  // Setor de Nutrição - CRN
  AVALIACAO_NUTRICIONAL = 17,
  ELABORACAO_DIETAS = 18,
  ACOMPANHAMENTO_NUTRICIONAL = 19,
  SUPORTE_CUIDADOR = 20,
  
  // Setor de Psicologia - CRP
  AVALIACAO_PSICOLOGICA = 21,
  APOIO_PACIENTE = 22,
  APOIO_FAMILIA = 23,
  RELATORIOS_EVOLUCAO_PSI = 24,
  
  // Setor de Farmácia - CRF
  DISPENSACAO_MEDICAMENTOS = 25,
  CONFERENCIA_PRESCRICOES = 26,
  ORIENTACAO_FARMACEUTICA = 27,
}
