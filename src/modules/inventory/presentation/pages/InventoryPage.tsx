...
export function InventoryPage() {
  ...
  // Optimized: Calculate stats in a single pass (O(n)) and memoize to prevent re-calculation on re-renders.
  // Previous implementation used multiple .filter() calls which resulted in O(3n).
  const stats = useMemo(() => {
    if (!data?.data) {
