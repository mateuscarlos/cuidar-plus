...
const DashboardPage = () => (
  <div className="space-y-6">
    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <StatCard title="Total de Pacientes" value="128" description="+4 novos este mês" icon={Users} />
      <StatCard title="Atendimentos Hoje" value="45" description="12 pendentes" icon={Activity} />
      <StatCard title="Alerta de Estoque" value="7" description="Itens com estoque baixo" icon={AlertCircle} />
      <StatCard title="Insumos Entregues" value="1.203" description="+12% em relação ao mês anterior" icon={Package} />
    </div>
